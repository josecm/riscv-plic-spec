...
*PLIC Memory Map*
	...
	base + 0x3FFFFFC: Reserved	
	...
	base + 0x4000000: Virtual Interrupt Injection Registers 0 block 0
	base + 0x4000004: Virtual Interrupt Injection Registers 1 block 0
	base + 0x4000008: Virtual Interrupt Injection Registers 2 block 0
	...
	base + 0x4000FFC: Virtual Interrupt Injection Registers 1023 block 0
	base + 0x4001000: Virtual Interrupt Injection Registers 0 block 1
	base + 0x4001004: Virtual Interrupt Injection Registers 1 block 1
	base + 0x4001008: Virtual Interrupt Injection Registers 2 block 1 
	...
	base + 0x4001FFC: Virtual Interrupt Injection Registers 1023 block 1
	...
...
| *PLIC Register Block Name* | *Function*|*Register Block Size in Byte*| *Description*
|Virtual Interrupt Injection Registers
|Virtual Interrupt Injection Registers from Block #0 to #N for 15872 contexts
...
*PLIC Interrupt Pure Virtual Memory Map* +
	...
	0x4200000: Block ID Register bit 0-31 virtual context 0
	0x4201000: Block ID Register bit 0-31 virtual context 1
	0x4202000: Block ID Register bit 0-31 virtual context 2
	0x4203000: Block ID Register bit 0-31 virtual context 3
